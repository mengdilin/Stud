...
- (void)__bindItem
{
    //implement imageView later
    //self.imageView.image = self.item[;
    self.textLabel.text = self.item[@"name"];
    [self.textLabel sizeToFit];
    self.detailTextLabel.text = self.item[@"location"];
...
- (void)viewDidLoad
{
    ...
    self.backgroundView.backgroundColor = [UIColor colorWithPatternImage:UIGraphicsGetImageFromCurrentImageContext()];
