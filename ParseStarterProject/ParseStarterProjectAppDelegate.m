...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [Parse setApplicationId:@"P9i0IDj5Xlje6NLePpmOohpoM0xiS0MTGOXEdeln"
                  clientKey:@"No8EFLdd9bVMsMZfNO8pY1jVSjUwk41Tq7irkn05"];
    ...
    MMMLoginViewController *logInVC = [[MMMLoginViewController alloc] init];

    UINavigationController *nc = [[UINavigationController alloc] initWithRootViewController:logInVC];
    nc.navigationBar.barTintColor = Rgb2UIColor(80, 195, 174);
